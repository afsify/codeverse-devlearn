          ...
          <div className="flex flex-col md:flex-row justify-center mt-3 gap-y-2 md:justify-evenly">
            ...
            >
              ...
              {dev?.user ? (
                <>
                  {dev?.status === "accepted" ? (
                    <p className="text-gray-600 text-center">
                      ...
                      You are now part of the DevHub community, and your profile
                      is visible for other users to discover and connect with
                      you. Welcome to DevHub, where great minds come together!
                    </p>
                  ) : (
                    <p className="text-gray-600 text-center">
                      Thank you for submitting your Developer Form! Your details
                      have been received. Please note that the form will undergo
                      admin verification. Once approved, your status will be
                      updated. If rejected, the status will be marked as
                      rejected.
                    </p>
                  )}
                  <div className="bg-white shadow-lg rounded-lg p-6 md:w-80 mx-auto mt-3">
                ...
                <p className="text-gray-600 text-center">
                  Thank you for choosing DevHub! To become a registered member,
                  please fill out the Developer Form for verification. Once
                  approved, your status will be updated, and you&apos;ll be
                  listed as a DevHub developer with a special developer badge!
                  <TokenRoundedIcon
                    className="ml-1 mb-1"
